...
const glbPath = '/robot_playground.glb';

export function Robot(props) {
    const group = useRef()
    const { nodes, materials, animations } = useGLTF(glbPath)
    const { actions } = useAnimations(animations, group)
        // Automatically play animations when the component mounts
        useEffect(() => {
  ...
  return (
    <group ref={group} scale={0.31} position={[1.7, -1.5, 0]} {...props} dispose={null} >
